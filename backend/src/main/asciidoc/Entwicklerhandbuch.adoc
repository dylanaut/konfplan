...
* mailpit als testcontainer in docker/colima schlägt fehl?
* postgres:18 als testcontainer in docker/colima funktioniert
** erfordert Anlagen einer DB instanz

* Vorbereitung ryuk für arm64/M2 aarch
