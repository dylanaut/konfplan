...
(
    ...
    endetAm            TIMESTAMP,
    deadlineReferenten TIMESTAMP,
    deadlineTeilnehmer TIMESTAMP,
    logo               VARCHAR(255),
...
(
    ...
    FOREIGN KEY (teilnehmer_id) REFERENCES Nutzer (id) ON DELETE CASCADE,
    FOREIGN KEY (eventslot_id) REFERENCES EventSlot (id) ON DELETE CASCADE
);
...
(
    ...
    FOREIGN KEY (referent_id) REFERENCES Nutzer (id) ON DELETE CASCADE,
    FOREIGN KEY (veranstaltung_id) REFERENCES Veranstaltung (id) ON DELETE CASCADE,
