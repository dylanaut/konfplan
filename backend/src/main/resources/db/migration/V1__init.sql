...
-- DEMO Referent
INSERT INTO "User" (email, password_hash, role, first_name, last_name, is_active, version)
VALUES ('beau.referent@yahoo.de', '$2a$10$8920ztppz0N29GNOOw1FCuZJqMUIJhybpqw9tKwkS0rR3BmELJIlC', 'REFERENT',
        'Beau',
        'Referent', TRUE, 1);

-- Demo Teilnehmer
INSERT INTO "User" (email, password_hash, role, first_name, last_name, is_active, version)
VALUES ('beau.teilnehmer@yahoo.de', '$2a$10$8920ztppz0N29GNOOw1FCuZJqMUIJhybpqw9tKwkS0rR3BmELJIlC', 'TEILNEHMER',
        'Beau',
        'Teilnehmer', TRUE, 1);
