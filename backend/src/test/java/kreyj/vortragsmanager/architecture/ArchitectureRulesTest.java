package kreyj.vortragsmanager.architecture;
...
// ─────────────────────────────────────────────────────────────────────────────
// Basispaket anpassen: kreyj.vortragsmanager → euer Root-Package
// Framework: Quarkus (CDI, JAX-RS, MicroProfile, Hibernate Panache)
// ─────────────────────────────────────────────────────────────────────────────
@AnalyzeClasses(
        packages = "kreyj.vortragsmanager",
...
public class ArchitectureRulesTest {
    ...
    //      presentation  → kreyj.vortragsmanager.presentation
    //      application   → kreyj.vortragsmanager.application
    //      domain        → kreyj.vortragsmanager.domain
    //      infrastructure→ kreyj.vortragsmanager.infrastructure
    //      persistence   → kreyj.vortragsmanager.persistence
    // ─────────────────────────────────────────────────────────────────────────
    ...
    static final ArchRule LAYERED_ARCHITECTURE =
            layeredArchitecture()
                    ...
                    .layer("Presentation").definedBy("kreyj.vortragsmanager.presentation..")
                    .layer("Application").definedBy("kreyj.vortragsmanager.application..")
                    .layer("Domain").definedBy("kreyj.vortragsmanager.domain..")
                    .layer("Infrastructure").definedBy("kreyj.vortragsmanager.infrastructure..")
                    .layer("Persistence").definedBy("kreyj.vortragsmanager.persistence..")
    ...
    static final ArchRule DOMAIN_FREE_OF_CDI_AND_FRAMEWORKS =
            noClasses()
                    .that().resideInAPackage("kreyj.vortragsmanager.domain..")
    ...
    static final ArchRule DOMAIN_FREE_OF_OTHER_LAYERS =
            noClasses()
                    ...
                    .should().dependOnClassesThat()
                    .resideInAnyPackage(
                            "kreyj.vortragsmanager.infrastructure..",
                            "kreyj.vortragsmanager.persistence..",
                            "kreyj.vortragsmanager.presentation.."
                    )
    ...
    static final ArchRule JAX_RS_RESOURCES_IN_PRESENTATION =
            classes()
                    ...
                    .should().resideInAPackage("kreyj.vortragsmanager.presentation..")
    ...
    static final ArchRule RESOURCES_NAMING_CONVENTION =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.presentation..")
    ...
    static final ArchRule PRESENTATION_NO_PERSISTENCE_ACCESS =
            noClasses()
                    .that().resideInAPackage("kreyj.vortragsmanager.presentation..")
                    .should().dependOnClassesThat()
                    .resideInAPackage("kreyj.vortragsmanager.persistence..")
    ...
    static final ArchRule PRESENTATION_NO_DOMAIN_MODEL_ACCESS =
            noClasses()
                    .that().resideInAPackage("kreyj.vortragsmanager.presentation..")
                    .should().dependOnClassesThat()
                    .resideInAPackage("kreyj.vortragsmanager.domain.model..")
    ...
    static final ArchRule APPLICATION_SCOPED_IN_CORRECT_LAYERS =
            classes()
                    ...
                    .should().resideInAnyPackage(
                            "kreyj.vortragsmanager.application..",
                            "kreyj.vortragsmanager.infrastructure..",
                            "kreyj.vortragsmanager.persistence.."
                    )
    ...
    static final ArchRule APPLICATION_SERVICES_NAMING =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.application..")
    ...
    static final ArchRule PANACHE_REPOSITORIES_IN_PERSISTENCE =
            classes()
                    ...
                    .should().resideInAPackage("kreyj.vortragsmanager.persistence..")
    ...
    static final ArchRule REPOSITORIES_NAMING_CONVENTION =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.persistence..")
    ...
    static final ArchRule DOMAIN_PORTS_ARE_INTERFACES =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.domain.port..")
                    .should().beInterfaces()
    ...
    static final ArchRule INBOUND_PORTS_NAMING =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.domain.port.in..")
    ...
    static final ArchRule OUTBOUND_PORTS_NAMING =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.domain.port.out..")
    ...
    static final ArchRule NO_FIELD_INJECTION =
            noFields()
                    ...
                    .resideInAPackage("kreyj.vortragsmanager..")
    ...
    static final ArchRule REST_CLIENTS_IN_INFRASTRUCTURE =
            classes()
                    ...
                    .should().resideInAPackage("kreyj.vortragsmanager.infrastructure..")
    ...
    static final ArchRule CONFIG_MAPPING_IN_INFRASTRUCTURE =
            classes()
                    ...
                    .should().resideInAPackage("kreyj.vortragsmanager.infrastructure.config..")
    ...
    static final ArchRule DOMAIN_EVENTS_ARE_POJOS =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.domain.event..")
    ...
    static final ArchRule DOMAIN_EXCEPTIONS_IN_DOMAIN =
            classes()
                    ...
                    .should().resideInAPackage("kreyj.vortragsmanager.domain.exception..")
    ...
    static final ArchRule DOMAIN_EXCEPTIONS_EXTEND_RUNTIME =
            classes()
                    .that().resideInAPackage("kreyj.vortragsmanager.domain.exception..")
    ...
    static final ArchRule NO_CYCLES_IN_APPLICATION =
            slices()
                    .matching("kreyj.vortragsmanager.application.(*)..")
    ...
    static final ArchRule NO_CYCLES_IN_DOMAIN =
            slices()
                    .matching("kreyj.vortragsmanager.domain.(*)..")
                    .should().beFreeOfCycles()
    ...
    static final ArchRule NO_CYCLES_GLOBALLY =
            slices()
                    .matching("kreyj.vortragsmanager.(*)..")
                    .should().beFreeOfCycles()
    ...
    void verifyAllRulesProgrammatically() {
        JavaClasses classes = new ClassFileImporter()
                ...
                .importPackages("kreyj.vortragsmanager");
