...
class NutzerInheritanceTest extends DatabaseCleaner {
    ...
    public void testPersistTeilnehmerViaJson() {
        anlegeGruppenkategorieMitWert("Klasse", "10.3");
        ...
        String json = """
                {
                    ...
                    "lastName": "Lernbereit",
                    "role": "TEILNEHMER",
                    "gruppenwerteByKategorie": {"Klasse": ["10.3"]},
                    "isActive": true
                }""";
    ...
    @Transactional
    void anlegeGruppenkategorieMitWert(String kategorieName, String wert) {
        Gruppenkategorie kategorie = new Gruppenkategorie(Veranstaltung.findById(testVid), kategorieName, false, false);
        kategorie.persist();
