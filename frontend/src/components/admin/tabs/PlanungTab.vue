  ...
  <section class="space-y-4 animate-fade-in">
    ...
    <div class="bg-indigo-900 text-white p-6 rounded-2xl shadow-xl flex flex-col md:flex-row items-end justify-between gap-6">
      ...
      <div class="text-right">
        ...
        <button @click="emit('startOptimization', solverConfig)" :disabled="isOptimizing || teilnehmerMitPrioritaetenCount === 0" class="bg-green-500 hover:bg-green-400 disabled:bg-gray-600 text-white px-8 py-4 rounded-xl font-black text-lg shadow-2xl transition-all transform hover:scale-105 flex items-center gap-3">
...
import { Loader as LoaderIcon, Zap as ZapIcon } from 'lucide-vue-next';
