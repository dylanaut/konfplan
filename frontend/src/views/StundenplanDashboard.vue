  ...
  <div class="container mt-5">
    ...
    <div v-else>
      <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        <h1 class="h3">Stundenplan-Dashboard</h1>
      ...
      <!-- Dies ist ein Platzhalter, da die Logik komplex ist -->
      <div class="alert alert-info">
        Die detaillierte Ansicht des Stundenplan-Dashboards wird hier implementiert.
      </div>
    </div>
...
onMounted(async () => {
  ...
  try {
    const response = await api.get(`/api/reports/${veranstaltungId}/admin-dashboard-data`);
